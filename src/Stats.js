      ...
      <div className='container-fluid'>
        ...
        <Table striped bordered hover variant='dark'>
          ...
          <tbody>
            ...
            <tr>
              <td>February</td>
              <td>TBD {/* {props.distances.februaryDistance.toFixed(2)} */}</td>
            </tr>
            <tr>
              <td>March</td>
            ...
            <tr>
              <td>May</td>
              <td>TBD {/* {props.distances.mayDistance.toFixed(2)} */}</td>
            </tr>
            <tr>
              <td>June</td>
            ...
            <tr>
              <td>July</td>
              <td>TBD {/* {props.distances.julyDistance.toFixed(2)} */}</td>
            </tr>
            <tr>
              <td>August</td>
              <td>TBD {/* {props.distances.augustDistance.toFixed(2)} */}</td>
            </tr>
            <tr>
              <td>September</td>
            ...
            <tr>
              <td>October</td>
              <td>TBD {/* {props.distances.octoberDistance.toFixed(2)} */}</td>
            </tr>
            <tr>
              <td>November</td>
