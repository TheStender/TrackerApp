...
function MonthlyMileage(props){
  ...
  const data = {
    ...
    datasets: [
      ...
      {
        label: '2021',
        data: [props.distances.januaryDistance.toFixed(2), props.distances.februaryDistance.toFixed(2), props.distances.marchDistance.toFixed(2), props.distances.aprilDistance.toFixed(2), props.distances.mayDistance.toFixed(2), props.distances.juneDistance.toFixed(2), props.distances.julyDistance.toFixed(2), props.distances.augustDistance.toFixed(2)],
        fill: false,
