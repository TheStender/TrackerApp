...
function LineChart(props){
  ...
  const data = {
    ...
    datasets: [
      ...
      {
        label: '2021',
        data: [props.distances.januaryDistance, props.distances.februaryDistance, props.distances.marchDistance, props.distances.aprilDistance, props.distances.mayDistance],
        fill: false,
