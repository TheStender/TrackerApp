...
function LineChart(props){
  ...
  const data = {
    ...
    datasets: [
      ...
      {
        label: '2021',
        data: [januaryTotal.toFixed(2), februaryTotal.toFixed(2), marchTotal.toFixed(2), aprilTotal.toFixed(2), mayTotal.toFixed(2), juneTotal.toFixed(2), julyTotal.toFixed(2), augustTotal.toFixed(2)],
        fill: false,
